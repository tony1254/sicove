<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="form2.aspx.vb" Inherits="WebApplication1.form2" %>
...
<div class="panel panel-primary"><!-- ENCABEZADO color-->  
  <div class="panel-heading">
    <h3 class="panel-title text-center"> DATOS DE FACTURACION <spam class="glyphicon glyphicon-user"></spam></h3>
      <!-- ENCABEZADO-->           
  ...
  <div class="row"> <!--fila dentro del cuerpo para alinear texto imaginaria  -->
          ...
          <div class="col-md-6 col-md-offset-3">
            ...
            <br /> <!-- salto-->
     <!-- BOTON crear-->
    <asp:LinkButton ID="Button" runat="server" Text="<span class='glyphicon glyphicon-plus'></span>Agregar Producto" Class="btn btn-lg btn-primary btn-block" />
        </div> 
          </div> 
</div>
     </div>   
